...
#define NODE_MAIN_LOGGER_NAME "cam_capture_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmonot_esp.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<CamCaptureNode>";
