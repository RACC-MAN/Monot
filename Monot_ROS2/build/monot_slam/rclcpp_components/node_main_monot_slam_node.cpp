...
#define NODE_MAIN_LOGGER_NAME "monot_slam_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmonot_slam.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<MonotSlamNode>";
